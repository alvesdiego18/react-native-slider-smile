            ...
            <>
                {
                    ...
                    <View style={{ width: 20, height: 20, borderRadius: 10, justifyContent: 'center', alignItems: 'center' }}>
                        <Animated.Text style={{ color: '#000', fontSize: 10, marginBottom: 1, fontWeight: 'bold' }}>{this.state.value}</Animated.Text>
                    </View>
                }
            </>
        );
